...
class IAMRole(GenericBaseModel):
    ...
    def update_resource(self, new_resource, stack_name, resources):
        ...
        _states = new_resource.get("_last_deployed_state", None)
        client = connect_to().iam
        ...
        if _states:
            ...
            # name_autogenerated = "RoleName" not in new_resource["SpecifiedProperties"]
            new_role_name = props.get("RoleName")
            name_changed = new_role_name and new_role_name != _states["RoleName"]

            # replacement_needed = (new_role_name and name_autogenerated) or (new_role_name and not name_autogenerated and name_changed) or (not new_role_name and not name_autogenerated)
            # if new_role_name and name_autogenerated:
            #     # replacement
            #     ...
            # if not new_role_name and name_autogenerated:
            #     # nothing, still use autogenerated name
            #     ...
            # if new_role_name and not name_autogenerated and name_changed:
            #     # replacement
            #     ...
            # if not new_role_name and not name_autogenerated:
            # now we need to autogenerate a name and do a replacement
